<template>
    <view id="_root" :class="(selectable ? '_select ' : '') + '_root'" :style="containerStyle">
        ...
        <!-- #endif -->
        <!-- #ifdef APP-PLUS-NVUE -->
        <web-view ref="web" src="/static/app-plus/m-view-html/local.html" :style="'margin-top:-2px;height:' + height + 'px'" @onPostMessage="_onMessage" />
        <!-- #endif -->
    </view>
</template>
 ...
 * m-view-html v1.0.0
 * @description 富文本组件
 * @tutorial https://github.com/jin-yufeng/m-view-html
