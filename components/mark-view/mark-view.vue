<template>
    <view class="mark-view">
        <m-view-html :key="mViewkey" :selectable="selectable" :scroll-table="scrollTable" :tag-style="tagStyle" :markdown="true" :content="html"></m-view-html>
    </view>
</template>

<script>
import mViewHtml from '../m-view-html/m-view-html';
