...
/// 
/// - Since: 5.4.1
- (void)initWithAppKey:(nonnull NSString *)appKey option:(nullable RCInitOption *)option;
...
/// ```
- (RCDownloadInfo *)getDownloadInfo:(NSString *)mediaUrl;
...
/// - Parameter delegate: 代理
/// - Since: 5.6.7
- (void)setReadReceiptV4Delegate:(id<RCReadReceiptV4Delegate>)delegate;

/// 已读状态代理(设置该代理可忽略 RCLibDispatchReadReceiptNotification)
/// - Parameter delegate: 代理
/// - Since: 5.6.7
- (void)setConversationReadStatusDelegate:(id<RCConversationChannelSyncConversationReadStatusDelegate>)delegate;
...
///
/// - Since: 5.8.1
- (void)querySubscribeEvent:(RCSubscribeEventRequest *)request pageSize:(NSInteger)pageSize startIndex:(NSInteger)startIndex completion:(void (^)(RCErrorCode status, NSArray<RCSubscribeInfoEvent *> * _Nullable subscribeEvents))completion;
...
/// - Since: 5.8.1
- (void)addSubscribeEventDelegate:(id<RCSubscribeEventDelegate>)delegate;
...
///
/// - Since: 5.10.0
- (void)getMyUserProfileVisibility:(void (^)(RCUserProfileVisibility visibility))successBlock
                             error:(nullable void (^)(RCErrorCode errorCode))errorBlock;
...
///
/// - Since: 5.10.0
- (void)getMyUserProfile:(void (^)(RCUserProfile *userProfile))successBlock
                   error:(nullable void (^)(RCErrorCode errorCode))errorBlock;
...
- (void)getUserProfiles:(NSArray<NSString *> *)userIds
                success:(void(^)(NSArray<RCUserProfile *> *userProfiles))successBlock
                  error:(nullable void (^)(RCErrorCode errorCode))errorBlock;
...
- (void)searchUserProfileByUniqueId:(NSString *)uniqueId
                            success:(void(^)(RCUserProfile *userProfile))successBlock
                              error:(nullable void (^)(RCErrorCode errorCode))errorBlock;
...
/// - Since: 5.10.4
- (void)addDatabaseStatusDelegate:(id<RCDatabaseStatusDelegate>)delegate;
...
/// 添加群组事件回调代理
/// - Since: 5.12.0
- (void)addGroupEventDelegate:(id<RCGroupEventDelegate>)delegate;

/// 移除群组事件回调代理
/// - Since: 5.12.0
- (void)removeGroupEventDelegate:(id<RCGroupEventDelegate>)delegate;
...
/// 添加好友事件监听
/// - Since: 5.12.0
- (void)addFriendEventDelegate:(id<RCFriendEventDelegate>)delegate;

/// 移除好友事件监听
/// - Since: 5.12.0
- (void)removeFriendEventDelegate:(id<RCFriendEventDelegate>)delegate;
